...
class NextSessionTimes:
    def __init__(self, data):
        self.earth_rotation_speedup = data['16']
        self.event_type_id = data['12']
        self.fog_density = data['38']
        self.group_count = data['14']
        self.humidity = data['11']
        self.leave_marbles = data['17']
        self.max_to_display = data['1']
        self.race_week = data['37']
        self.race_week_cars = data['29']
        self.reg_count = data['19']
        self.rubber_practice = data['15']
        self.rubber_qualify = data['27']
        self.rubber_race = data['26']
        self.rubber_warmup = data['23']
        self.season_id = data['34']
        self.session_id = data['9']
        self.skies = data['7']
        self.special_event_type = data['25']
        self.temp_unit = data['22']
        self.temp_value = data['24']
        self.time_of_day = data['30']
        self.time_start = datetime_from_iracing_timestamp(data['8'])
        self.time_start_sim = parse_encode(data['32'])
        self.total_count = data['20']
        self.total_groups = data['33']
        self.track_id = data['4']
        self.weather_initial = data['10']
        self.weather_ongoing = data['28']
        self.weather_type = data['31']
        self.wind_direction = data['13']
        self.wind_speed_unit = data['2']
        self.wind_speed_value = data['6']
        self.grip_compound_warmup = data['3']
        self.grip_compound_race = data['5']
        self.grip_compound_qualify = data['18']
        self.grip_compound_practice = data['35']
        self.restrict_viewing = data['36']
        # Used outside of d dict; Holds refresh time of data
        # self.reloadtime = dict['21']
