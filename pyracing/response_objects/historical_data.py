...
class EventResults:
    def __init__(self, data):
        self.car_class_id = data['3']
        self.car_id = data['12']
        self.car_name = parse_encode(data['14'])
        self.cat_id = data['13']
        self.category = parse_encode(data['42'])
        self.cust_id = data['40']
        self.display_name = parse_encode(data['39'])
        self.drop_race_points = data['32']
        self.evt_type_name = parse_encode(data['41'])
        self.evt_type = data['18']
        self.finished_at = data['11']
        self.group_name = parse_encode(data['34'])
        self.incidents = data['21']
        self.lap_best_subsession = parse_encode(data['8'])
        self.lap_best = parse_encode(data['19'])
        self.lap_qual_best = parse_encode(data['6'])
        self.license_group = data['16']
        self.official_session = data['33']
        self.points_champ = data['22']
        self.points_club = data['30']
        self.pos_finish = data['4']
        self.pos_finish_class = data['36']
        self.pos_start = data['24']
        self.pos_start_class = data['1']
        self.race_week = data['9'] + 1
        self.season_id = data['38']
        self.season_quarter = data['15']
        self.season_year = data['25']
        self.series_id = data['35']
        self.series_name_short = parse_encode(data['31'])
        self.series_name = parse_encode(data['20'])
        self.session_id = data['10']
        self.start_date = data['26']
        self.strength_of_field = data['28']
        self.subsession_id = data['23']
        self.time_start_raw = data['17']
