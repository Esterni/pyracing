...
class EventResults:
    def __init__(self, dict):
        ...
        self.car_id = dict['11']
        self.car_name = parse_encode(dict['13'])
        self.cat_id = dict['12']
        self.category = parse_encode(dict['40'])
        self.cust_id = dict['38']
        self.display_name = parse_encode(dict['37'])
        self.drop_race_points = dict['31']
        self.evt_type_name = parse_encode(dict['39'])
        self.evt_type = dict['17']
        self.finished_at = dict['10']
        self.group_name = parse_encode(dict['33'])
        self.incidents = dict['20']
        self.lap_best_subsession = parse_encode(dict['7'])
        self.lap_best = parse_encode(dict['18'])
        self.lap_qual_best = parse_encode(dict['5'])
        self.license_group = dict['15']
        self.official_session = dict['32']
        self.points_champ = dict['21']
        self.points_club = dict['29']
        self.pos_finish = dict['3']
        self.pos_start = dict['23']
        self.race_week = dict['8'] + 1
        self.season_id = dict['36']
        self.season_quarter = dict['14']
        self.season_year = dict['24']
        self.series_id = dict['34']
        self.series_name_short = parse_encode(dict['30'])
        self.series_name = parse_encode(dict['19'])
        self.session_id = dict['9']
        self.start_date = dict['25']
        self.strength_of_field = dict['27']
        self.subsession_id = dict['22']
        self.time_start_raw = dict['16']
