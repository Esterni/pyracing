...
class OpenSubSession:
    def __init__(self, data):
        ...
        self.fog_density = data['weather_fog_density']
        self.gripcompoundpractice = data['gripcompoundpractice']
        self.gripcompoundqualify = data['gripcompoundqualify']
        self.gripcompoundrace = data['gripcompoundrace']
        self.gripcompoundwarmup = data['gripcompoundwarmup']
        self.humidity = data['weather_rh']
        self.leave_marbles = data['leavemarbles']
        self.ping = data['ping']
        ...
        self.race_week_num = data['race_week_num']
        ...
        self.track_id = data['trackid']
        self.weather_type = data['weather_type']
        self.weather_var_intial = data['weather_var_intial']
        self.weather_var_ongoing = data['weather_var_ongoing']
        self.wind_direction = data['weather_wind_dir']
        self.wind_speed_unit = data['weather_wind_speed_units']
        self.wind_speed_value = data['weather_wind_speed_value']
